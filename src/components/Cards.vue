  ...
  <div class="flex flex-col max-w-[calc(100%-30px)] mx-auto text-center py-8 sm:pt-16 md:max-w-[1080px] md:px-5 lg:px-0">
    ...
    <div class="flex flex-col md:flex-row md:flex-wrap">
      <div class="w-[344px] mx-auto bg-cardBlue p-6 text-start mb-6">
        ...
        <p class="font-semibold mb-6 text-lg">What's included</p>

        <ul>
          <li class="flex justify-between items-center py-4 border-y border-line">
            <p class="text-gray">Excepteur sint occaecat velit</p>
          ...
          <li class="flex justify-between items-center py-4 border-y border-line">
            <p class="text-gray">Excepteur sint occaecat velit</p>
            <div class="w-4 h-[0.3px] bg-line"></div>
          </li>
          <li class="flex justify-between items-center py-4 border-y border-line">
            <p class="text-gray">Excepteur sint occaecat velit</p>
            <div class="w-4 h-[0.3px] bg-line"></div>
