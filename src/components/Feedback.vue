<template>
  <div class="flex flex-col max-w-[calc(100%-30px)] mx-auto text-center py-8">
    <div class="flex flex-col pb-16 border-b-[0.1px] border-line">
      ...
      <div class="flex w-20 mx-auto">
        <div class="w-2 h-2 bg-line rounded-full cursor-pointer mx-1.5 hover:bg-gray"></div>
        <div class="w-2 h-2 bg-line rounded-full cursor-pointer mx-1.5 hover:bg-gray"></div>
        <div class="w-2 h-2 bg-gray rounded-full cursor-pointer mx-1.5"></div>
      </div>
    </div>
  </div>
</template>