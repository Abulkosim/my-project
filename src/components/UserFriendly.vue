<template>
  <div
    class="py-5 flex flex-col md:flex-row md:flex-wrap md:max-w-[1080px] md:px-5 mx-auto border-b-[0.1px] border-line">
    <div class="flex-col text-center max-w-xs mx-auto mb-8 sm:mb-12 p-2">
      ...
      <h2 class="text-2xl font-semibold mb-3">User friendly</h2>
      <p class="text-gray text-lg">A pseudo-Latin text used in web design, layout, and printing in place of things to
        emphasise design.
      </p>
    </div>
    <div class="flex-col text-center max-w-xs mx-auto mb-8 sm:mb-12 p-2">
